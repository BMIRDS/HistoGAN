...
input_folders = ['normal', '../models/nototv/test/', '../models/nototv_2/test/', '../models/nototv_4/test/', '../models/nototv_8/test/', '../models/nototv_16/test/', '../models/nototv_32/test/']  #Manaully change this, inputs of folder
